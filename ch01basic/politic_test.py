...
naver_news = []
section_list = {'정치' : json_politics_news, '경제' : json_economys_news, 'IT' : json_sports_news, '스포츠' : json_its_news}

def file_open(section_list):
    for key in section_list.items():
        with open('D:\\PythonProject\\MyPython\\ch01basic\\'  + ' _naver_news1.json', 'r', encoding='utf-8') as f1:

file_open(section_list)
